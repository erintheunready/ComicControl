<?php //gallery-main.php - main page for managing gallery modules ?>

<main id="content">

<?php //buttons for adding and rearranging images as well as managing gallery options ?>
...
<?php //output container for holding AJAX request ?>
