...
$version = file_get_contents("http://www.comicctrl.com/version-control/getversion.php");
...
//otherwise, download upgrade scripts and give options for updating
	...
	copy("http://www.comicctrl.com/version-control/upgradescripts/upgrade.txt", dirname(__FILE__) . "/upgrade.php");
